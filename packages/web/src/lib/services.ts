...
import pluginAgentGlm from "@composio/ao-plugin-agent-glm";
...
import pluginTrackerBmad from "@composio/ao-plugin-tracker-bmad";
...
async function initServices(): Promise<Services> {
  ...
  registry.register(pluginAgentGlm);
  registry.register(pluginWorkspaceWorktree);
  registry.register(pluginScmGithub);
  registry.register(pluginTrackerBmad);
